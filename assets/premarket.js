/* ==================================================================
   盘前研判 · 实时触发监控
   关键位基于最近收盘K线测算（日期由 morning-brief.js 自动更新）：
...
(function() {
  ...
  var HOLDS = [
    {
      tc: 'sh600498', name: '烽火通信', code: '600498', shares: 200, cost: 40.025,
      snap: 40.240, snapPct: +0.54,
      sellTxt: '41.5-42.0 高抛100股', sellPx: 41.5,
      buyTxt: '38.5-39.0 回踩接回', buyPx: 39.0,
      stopTxt: '37.50', stopPx: 37.5,
      plan: '新建仓200股微盈+0.5%：光通信龙头，算力网络受益；40附近震荡整固，站稳42则看高一线；跌破38.5减仓防守'
    },
    {
      tc: 'sh600353', name: '旭光电子', code: '600353', shares: 200, cost: 32.385,
      snap: 31.730, snapPct: -2.02,
      sellTxt: '33.0-34.0 做T高抛100股', sellPx: 33.0,
      buyTxt: '30.0-30.5 回踩企稳接回', buyPx: 30.5,
      stopTxt: '29.50', stopPx: 29.5,
      plan: '200股浅套-2%：31附近有支撑，企稳可做T低吸；反弹到33-34高抛降成本；成本32.385，回本需+2%'
    },
    {
      tc: 'sh512760', name: '芯片ETF', code: '512760', shares: 400, cost: 1.323,
      snap: 1.106, snapPct: -2.53,
      sellTxt: '1.15-1.18 反弹减100份', sellPx: 1.15,
      buyTxt: '1.05-1.07 企稳接回', buyPx: 1.07,
      stopTxt: '1.03', stopPx: 1.03,
      plan: '深套-16.4%不止损：1.03-1.07区间分批补仓摊薄成本；反弹到1.15以上减100份做T；半导体周期底部磨底阶段'
    },
    {
      tc: 'sh515050', name: '5GETF', code: '515050', shares: 300, cost: 1.241,
      snap: 1.042, snapPct: -2.91,
      sellTxt: '1.08-1.10 做T卖出50-100份', sellPx: 1.08,
      buyTxt: '0.99-1.01 企稳接回', buyPx: 1.00,
      stopTxt: '0.97', stopPx: 0.97,
      plan: '深套-16.1%：0.97-1.01区间是低位区，可分批补仓；反弹到1.08以上做T减仓；通信板块估值低位，以时间换空间'
    }
  ];
  ...
  var OPPS = [
    ...
    },
    {
      ...
      logic: 'PCB主线龙头8/21放量+6%创阶段新高；不追高，等回踩114-116缩量企稳再介入；与烽火同属通信链，注意行业集中度'
    },
    {
