  ...
  var HOLDS = [
    {
      ...
      snap: 31.250, snapPct: -3.51,
      sellTxt: '33.0-34.0 做T高抛100股', sellPx: 33.0,
      buyTxt: '30.0-30.5 回踩企稳接回', buyPx: 30.5,
      stopTxt: '29.50', stopPx: 29.5,
      plan: '200股浅套-3.5%：31附近有支撑，企稳可做T低吸；反弹到33-34高抛降成本；成本32.385，回本需+3.5%'
    },
    {
      tc: 'sz002436', name: '兴森科技', code: '002436', shares: 400, cost: 38.220,
      snap: 33.410, snapPct: -12.59,
      sellTxt: '35.0轻压 / 36.5-37.0 做T高抛100股', sellPx: 35.0,
      buyTxt: '32.0-32.5 做T低吸100股', buyPx: 32.5,
      stopTxt: '31.00', stopPx: 31.0,
      plan: '400股深套-12.6%：33附近有支撑，企稳可做T低吸；反弹到35-36高抛降成本；成本38.22，回本需+14.4%，以时间换空间'
    },
    {
      tc: 'sh512760', name: '芯片ETF', code: '512760', shares: 400, cost: 1.323,
      snap: 1.086, snapPct: -2.53,
      sellTxt: '1.15-1.18 反弹减100份', sellPx: 1.15,
      buyTxt: '1.05-1.07 企稳接回', buyPx: 1.07,
      stopTxt: '1.03', stopPx: 1.03,
      plan: '深套-17.9%不止损：1.03-1.07区间分批补仓摊薄成本；反弹到1.15以上减100份做T；半导体周期底部磨底阶段'
    },
    {
      tc: 'sh515050', name: '5GETF', code: '515050', shares: 300, cost: 1.241,
      snap: 0.987, snapPct: -2.91,
      sellTxt: '1.05-1.08 做T卖出50-100份', sellPx: 1.05,
      buyTxt: '0.95-0.97 企稳接回', buyPx: 0.97,
      stopTxt: '0.93', stopPx: 0.93,
      plan: '深套-20.5%：0.93-0.97区间是历史低位区，可分批补仓；反弹到1.05以上做T减仓；通信板块估值低位，以时间换空间'
    }
  ];
