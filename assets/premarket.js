...
(function() {
  ...
  var HOLDS = [
    {
      tc: 'sh600353', name: '旭光电子', code: '600353', shares: 200, cost: 39.208,
      snap: 37.020, snapPct: -1.58,
      sellTxt: '40.0-42.0 减仓100股', sellPx: 40.0,
      buyTxt: '35.8-36.5 回踩企稳接回', buyPx: 36.5,
      stopTxt: '33.50', stopPx: 33.5,
      plan: '弱势震荡：37附近支撑考验，跌破36.5先减半；上方40-42压力区减仓；成本39.21，回本需+5.9%'
    },
    {
      tc: 'sz002436', name: '兴森科技', code: '002436', shares: 300, cost: 39.575,
      snap: 33.240, snapPct: -2.84,
      sellTxt: '35.0轻压 / 36.5-37.0 做T高抛100股', sellPx: 36.5,
      buyTxt: '32.0-32.5 做T低吸100股', buyPx: 32.5,
      stopTxt: '31.50', stopPx: 31.5,
      plan: '300股深套-16%：32-33附近有支撑，企稳可做T低吸；反弹到36-37高抛降成本；成本39.575，回本需+19%，以时间换空间'
    },
    {
      tc: 'sh512760', name: '芯片ETF', code: '512760', shares: 400, cost: 1.323,
      snap: 1.117, snapPct: -2.53,
      sellTxt: '1.18-1.20 反弹减100份', sellPx: 1.18,
      buyTxt: '1.08-1.10 企稳接回', buyPx: 1.10,
      stopTxt: '1.05', stopPx: 1.05,
      plan: '深套-15.6%不止损：1.05-1.10区间分批补仓摊薄成本；反弹到1.18以上减100份做T；半导体周期底部磨底阶段'
    },
    {
      tc: 'sh515050', name: '5GETF', code: '515050', shares: 300, cost: 1.241,
      snap: 1.003, snapPct: -2.91,
      sellTxt: '1.08-1.10 做T卖出50-100份', sellPx: 1.08,
      buyTxt: '0.97-0.99 企稳接回', buyPx: 0.99,
      stopTxt: '0.95', stopPx: 0.95,
      plan: '深套-19.2%：0.95-1.00区间是历史低位区，可分批补仓；反弹到1.08以上做T减仓；通信板块估值低位，以时间换空间'
    }
  ];
